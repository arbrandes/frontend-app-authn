      ...
      <div className="w-100 p-0 mb-3 d-flex">
        <div className="col-md-10 bg-primary-400">
          <Hyperlink destination={getAppConfig('openedxAuthn').MARKETING_SITE_BASE_URL}>
            <Image alt={getConfig().siteName} className="logo" src={getAppConfig('openedxAuthn').LOGO_WHITE_URL} />
          </Hyperlink>
          <div className="d-flex align-items-center justify-content-center mb-4 ">
            <div className={classNames({ 'mt-1 medium-yellow-line': getConfig().siteName === 'edX' })} />
            <div>
              <h1
                className={classNames(
                  'display-1 text-white mt-5 mb-5 mr-2 main-heading',
                  { 'ml-4.5': getConfig().siteName !== 'edX' },
                )}
              >
                <span>
