...
const LargeLayout = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${getAppConfig('openedxAuthn').BANNER_IMAGE_LARGE})` }}
    >
      <Hyperlink destination={getAppConfig('openedxAuthn').MARKETING_SITE_BASE_URL}>
        <Image className="company-logo position-absolute" alt={getConfig().siteName} src={getAppConfig('openedxAuthn').LOGO_WHITE_URL} />
      </Hyperlink>
