...
const RegistrationPage = (props) => {
  ...
  const flags = {
    ...
    autoGeneratedUsernameEnabled: getConfig().custom.ENABLE_AUTO_GENERATED_USERNAME,
  };
  const {
  ...
  useEffect(() => {
    if (registrationResult.success) {
      ...
      setCookie(getConfig().custom.USER_RETENTION_COOKIE_NAME, true);
    }
  }, [registrationResult]);
      ...
      <>
        ...
        <RedirectLogistration
          ...
          redirectToProgressiveProfilingPage={
            getConfig().custom.ENABLE_PROGRESSIVE_PROFILING_ON_AUTHN && !!Object.keys(optionalFields.fields).length
          }
        />
